...
import { HomeIcon, LockIcon, type LucideIcon, X } from "lucide-react";
...
const SidebarLink = ({ href, icon: Icon, label }: SidebarLinkProps) => {
	...
	return (
		<Link href={href} className="w-full">
			<div
				className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:bg-gray-700 ${isActive ? "bg-gray-100 text-white dark:bg-gray-600" : ""} justify-start px-8 py-3`}
			>
				{isActive && (
